...
public class FundsWithdrawnEvent : AggregateEvent<BankAccount>
{
    public Guid AccountId { get; }

    public FundsWithdrawnEvent(Guid accountId, decimal amount)
    {
        AccountId = accountId;
        Amount = amount;
    }
    ...
    {
        return new FundsDepositedEvent(AccountId, Amount);
    }
}